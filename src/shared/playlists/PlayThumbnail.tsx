...
import { useUserId, useAuthenticated } from '@nhost/nextjs';
import countByProp from '@/shared/utils/commonUtils';
import { loadCoverImage } from '@/shared/utils/coverImageUtil';
...
const PlayThumbnail = ({ play }: Props) => {
